-- Fix Supabase security issues (CORRECTED VERSION)
...
-- Note: Only including columns that actually exist in coaches table
...
-- Fixed: Cast UUID to text for comparison
...
-- Only includes columns that exist in the coaches table.
...
-- Fixed UUID casting issue in author comparison
