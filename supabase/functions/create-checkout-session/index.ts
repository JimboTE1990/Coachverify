 ...
 * Endpoint: https://YOUR_PROJECT.supabase.co/functions/v1/create-checkout-session
 *
 * This function creates a Stripe Checkout Session for subscription payments.
 * Runs on Supabase Edge Runtime with reliable environment variable support.
 */
  ...
  try {
    ...
    if (stripePromotionCodeId) {
      ...
      const couponMap: Record<string, string> = {
        'LAUNCH50':  'promo_1THRejDye3rmKJaDiMbHLFwr',
        'BETA49':    'E7g5S88d',
        'EMCC15':    'NStyLey1',
