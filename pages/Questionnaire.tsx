...
import { QuestionnaireAnswers, Specialty, Format } from '../types';
    ...
    <div className="max-w-2xl mx-auto px-4 py-12 md:py-20">
      ...
      <div className="mb-8">
        <div className="flex justify-between mb-2">
          <span className="text-xs font-semibold tracking-wide uppercase text-brand-600">Step {step} of 4</span>
          <span className="text-xs font-semibold text-slate-400">{Math.round((step / 4) * 100)}% Completed</span>
        </div>
        <div className="h-2 bg-slate-100 rounded-full">
          <div className="h-2 bg-brand-500 rounded-full transition-all duration-500 ease-out" style={{ width: `${(step / 4) * 100}%` }}></div>
        </div>
      </div>
