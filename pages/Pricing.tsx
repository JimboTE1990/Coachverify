...
import { CheckCircle, Zap, Clock, Star, ArrowRight } from 'lucide-react';
    ...
    <div className="bg-slate-50 min-h-screen flex flex-col">
      ...
      <div className="pb-24 relative z-10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
             ...
             <div className="md:flex">
                <div className="p-10 md:w-2/3">
                   <div className="flex items-center mb-6">
                      <span className="bg-brand-100 text-brand-700 font-bold px-3 py-1 rounded-full text-xs uppercase tracking-wide mr-3 border border-brand-200">Step 1</span>
                      <h2 className="text-3xl font-display font-bold text-slate-900">Start with a Free Trial</h2>
                   </div>
                   <p className="text-slate-600 mb-8 text-lg leading-relaxed">
                      Get full access to all features immediately. Build your profile, get verified, and receive matches. No commitment required.
                   </p>
                   <ul className="space-y-3">
                      <li className="flex items-center text-slate-700 font-medium"><div className="bg-green-100 p-1 rounded-full mr-3"><CheckCircle className="h-4 w-4 text-green-600" /></div> Full Profile Visibility</li>
                      <li className="flex items-center text-slate-700 font-medium"><div className="bg-green-100 p-1 rounded-full mr-3"><CheckCircle className="h-4 w-4 text-green-600" /></div> Access to Client Matching</li>
                      <li className="flex items-center text-slate-700 font-medium"><div className="bg-green-100 p-1 rounded-full mr-3"><CheckCircle className="h-4 w-4 text-green-600" /></div> Verified Badge Process</li>
                   </ul>
                </div>
                <div className="bg-gradient-to-br from-brand-50 to-indigo-50 p-10 md:w-1/3 flex flex-col justify-center items-center border-t md:border-t-0 md:border-l border-slate-100">
                   <div className="text-center w-full">
                      ...
                      <p className="text-sm text-slate-500 font-bold uppercase tracking-wide mb-8">for 14 days</p>
                      <Link 
                        to="/coach-signup" 
          ...
          {/* 2. Paid Plans Section */}
          <div className="text-center mb-12">
             <span className="text-brand-600 font-bold text-sm uppercase tracking-widest">Step 2</span>
             <h3 className="text-3xl font-display font-bold text-slate-900 mt-2">Then, choose your plan</h3>
             <p className="text-slate-500 mt-2">Lock in the Early Bird 50% discount for life.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-8 flex flex-col items-center hover:shadow-md transition-shadow">
              ...
              <div className="mt-8 border-t border-slate-100 w-full pt-8">
                 ...
                 <ul className="space-y-4 text-left text-sm text-slate-600">
                    <li className="flex items-center"><CheckCircle className="h-5 w-5 text-brand-500 mr-3" /> Verified Profile</li>
                    <li className="flex items-center"><CheckCircle className="h-5 w-5 text-brand-500 mr-3" /> Unlimited Matches</li>
                    <li className="flex items-center"><CheckCircle className="h-5 w-5 text-brand-500 mr-3" /> Cancel Anytime</li>
                 </ul>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl border-2 border-brand-500 p-8 flex flex-col items-center relative transform md:-translate-y-4">
              ...
              <div className="mt-8 flex flex-col items-center justify-center">
                ...
                <span className="text-xs text-green-600 font-bold mt-2 bg-green-50 px-2 py-1 rounded-md">Save £150/year</span>
              </div>
              ...
              <div className="mt-8 border-t border-slate-100 w-full pt-8">
                 ...
                 <ul className="space-y-4 text-left text-sm text-slate-600">
                    <li className="flex items-center"><CheckCircle className="h-5 w-5 text-brand-500 mr-3" /> Priority Search Listing</li>
                    <li className="flex items-center"><CheckCircle className="h-5 w-5 text-brand-500 mr-3" /> "Featured" Badge</li>
                    <li className="flex items-center"><CheckCircle className="h-5 w-5 text-brand-500 mr-3" /> 2 Months Free</li>
                 </ul>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 flex justify-center">
             <div className="bg-yellow-50 rounded-2xl border border-yellow-100 p-6 inline-flex items-center space-x-4 max-w-2xl">
                ...
                <div className="text-left">
                   <p className="font-bold text-slate-900">Early Bird Guarantee</p>
                   <p className="text-sm text-slate-600">Sign up now to lock in this 50% discount for life, even if our prices go up later.</p>
                </div>
             </div>
          </div>
