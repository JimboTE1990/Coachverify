-- Update dummy/test coaches with placeholder accreditation URLs
-- This allows visual testing of the accreditation link feature

-- Update EMCC verified coaches with sample EMCC profile URLs
UPDATE coaches
...
-- Update ICF verified coaches with sample ICF profile URLs
UPDATE coaches
